...
#ifdef DEBUG
#ifdef __AD_LOG__
#define NSLogError(format, ...) NSLog((@"\033[" @"fg255,250,250;" @"\033[" @"bg0,0,0;" format ), ##__VA_ARGS__)
#undef NSLog
...
fprintf(stderr, "--------------------------------------\n");
#define NSLogBlue(format, ...) NSLog((@"\033[" @"fg0,0,255;" format ), ##__VA_ARGS__)
#define NSLogRed(format, ...) NSLog((@"\033[" @"fg255,0,0;" format ), ##__VA_ARGS__)
#define NSLogGreen(format, ...) NSLog((@"\033[" @"fg124,252,0;" format ), ##__VA_ARGS__)
#define NSLogBrown(format, ...) NSLog((@"\033[" @"fg160,82,45;" format ), ##__VA_ARGS__)
#endif
#else
